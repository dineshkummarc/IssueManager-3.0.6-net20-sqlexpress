<!--ASPX page @1-90DE3529-->
<%@ Page language="c#" CodeFile="install_mdb.aspx.cs" AutoEventWireup="false" Inherits="IssueManager.install_mdb.install_mdbPage" ResponseEncoding ="utf-8"%>

<%@ Import namespace="IssueManager.install_mdb" %>
...
<html>
<head>
<meta http-equiv="content-type" content="<%=install_mdbContentMeta%>">
                                                                ...
                                                                <tr class="Row">
                                                                                <td><%=Resources.strings.inst_introduce%><br>
                                                                                                ...
                                                                                                <table width="100%" border="0">
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                                <td style="BORDER-RIGHT: 0px; BORDER-TOP: 0px; BORDER-LEFT: 0px; BORDER-BOTTOM: 0px"><%=Resources.strings.inst_writable_db%></td> 
                                                                                                                                <td style="BORDER-RIGHT: 0px; BORDER-TOP: 0px; BORDER-LEFT: 0px; BORDER-BOTTOM: 0px"><b><asp:Literal id="DbWriteCheck" runat="server"/></b></td>
                                                                                                                </tr>
                                                                                                                <tr>
...
<br>
  ...
  <asp:PlaceHolder id="sql_environmentError" visible="False" runat="server">
                                                                                ...
                                                                                <tr class="Controls">
                                                                                                <th width="250"><%=Resources.strings.inst_site_url%> *</th>
	...
	runat="server"/></td> 
                                                                                ...
                                                                                <tr class="Footer">
                                                                                                <td colspan="2"><b><%=Resources.strings.inst_sql_environment_mdb%></b></td>
                                                                                </tr>

                                                                                <tr class="Controls">
                                                                                                <th><%=Resources.strings.inst_mdb_file_path%> *</th>
                                                                                                <td><asp:TextBox id="sql_environmentmdb_file" maxlength="200" Columns="40" style="width:100%"
	...
	runat="server"/></td> 
                                                                                ...
                                                                                <tr class="Controls">
                                                                                  ...
                                                                                  <td><asp:CheckBox id="sql_environmentUpgradeData" onclick="switchUpgrade(this.form,this.checked)" runat="server"/>&nbsp;</td>
                                                                                </tr>
