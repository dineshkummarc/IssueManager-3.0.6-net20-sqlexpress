...
namespace IssueManager.install_mssql{ //Namespace @1-03874A1A

//Forms Definition @1-762888E5
public partial class install_mssqlPage : System.Web.UI.Page
{
//End Forms Definition

//Forms Objects @1-F4F6D53C
    ...
    protected string install_mssqlContentMeta;
...
//OnInit Event @1-16E159B2
    ...
    override protected void OnInit(EventArgs e)
    {
        ...
        install_mssqlContentMeta = "text/html; charset=" +  ((CCSCultureInfo)System.Threading.Thread.CurrentThread.CurrentCulture).Encoding;
...
//Page install_mssql Event AfterInitialize. Action Custom Code @23-2A29BDB7
    // -------------------------
    // Write your own code here.
    // -------------------------
//End Page install_mssql Event AfterInitialize. Action Custom Code
